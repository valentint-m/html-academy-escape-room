...
import { getDateLocalizedName, getQuestUrlById } from '../../utils/utils';
  ...
  return (
    <div className="quest-card">
      ...
      <div className="quest-card__content">
        <div className="quest-card__info-wrapper"><Link className="quest-card__link" to={getQuestUrlById(reservedQuest.quest.id)}>{reservedQuest.quest.title}</Link><span className="quest-card__info">[{getDateLocalizedName(reservedQuest.date)},&nbsp;{reservedQuest.time}. {reservedQuest.location.address}]</span>
        </div>
